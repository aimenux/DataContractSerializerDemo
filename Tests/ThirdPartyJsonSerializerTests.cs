...
{
    [TestClass]
    public class ThirdPartyJsonSerializerTests
    {
        [TestMethod]
        public void Should_Serialize_Deserialize_Basic_Models_With_Json()
        {
            ...
            var serializer = new ThirdPartyJsonSerializer<BasicEmployee>();
        ...
        public void Should_Serialize_Deserialize_Custom_Models_With_Json()
        {
            ...
            var serializer = new ThirdPartyJsonSerializer<CustomEmployee>();
        ...
        public void Should_Serialize_Deserialize_ThirdParty_Models_With_Json()
        {
            ...
            var serializer = new ThirdPartyJsonSerializer<ThirdPartyEmployee>();
