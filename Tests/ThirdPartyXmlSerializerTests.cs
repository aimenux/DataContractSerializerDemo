...
{
    [TestClass]
    public class ThirdPartyXmlSerializerTests
    {
        [TestMethod]
        public void Should_Serialize_Deserialize_Basic_Models_With_Xml()
        {
            ...
            var serializer = new ThirdPartyXmlSerializer<BasicEmployee>();
        ...
        public void Should_Serialize_Deserialize_Custom_Models_With_Xml()
        {
            ...
            var serializer = new ThirdPartyXmlSerializer<CustomEmployee>();
        ...
        public void Should_Serialize_Deserialize_ThirdParty_Models_With_Xml()
        {
            ...
            var serializer = new ThirdPartyXmlSerializer<ThirdPartyEmployee>();
